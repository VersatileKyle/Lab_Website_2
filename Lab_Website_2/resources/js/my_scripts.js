...
function loadPlayersPage(){
	/*write html and inject it into the page*/
	var selectionText = "";
...
function switchPlayers(playerNum){
	...
	//Avgs of Yards
	document.getElementById('avg_p_yards').innerHTML = Math.round(players[playerNum].pass_yards / gamesPlayed);
	document.getElementById('avg_r_yards').innerHTML = Math.round(players[playerNum].rushing_yards / gamesPlayed);
	document.getElementById('avg_rec_yards').innerHTML = Math.round(players[playerNum].receiving_yards / gamesPlayed);
}
